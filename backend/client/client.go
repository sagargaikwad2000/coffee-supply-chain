...
func (c Client) Commit(request models.Request) error {
...
func (c Client) Query(request models.Request) (interface{}, error) {
	evaluateResult, err := c.contract.EvaluateTransaction(request.MethodName, request.Args...)
	if err != nil {
